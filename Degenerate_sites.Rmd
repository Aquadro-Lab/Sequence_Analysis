...
for (i in 1:ncol(Codons)) {
  Codon_temp = Codons[[i]]
  degenercy = hash[[Codon_temp]]
  degenercy_vector = c(degenercy_vector, degenercy)
}

degenercy_values = paste(degenercy_vector, collapse="")
degenercy_values_vector = unlist(strsplit(degenercy_values, split=""))

degenercy_table = table(degenercy_values_vector)
```
...
#### We want to calculate: n0 = # of nondegenerate sites, n2 = # of two-fold degenerate sites, and n4 = # of four-fold degenerate sites.

```{r}

if (length(degenercy_table) == 4) {
  
  n0 = degenercy_table[[1]]
  n2 = degenercy_table[[2]]
  n3 = degenercy_table[[3]]
  n4 = degenercy_table[[4]]
